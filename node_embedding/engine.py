...
try: import tesserocr
except ImportError: tesserocr = None
...
class MMOCR:
    def __init__(self,
                 ...
                 kie_config='',
                 kie_ckpt='',
                 config_dir=osp.join(str(Path.cwd()), 'configs/'),
                 device=None,
                 **kwargs):
        ...
        if self.td and self.td == 'Tesseract':
            ...
            if not det_config:
                det_config = osp.join(config_dir, 'textdet/',
        ...
        if self.kie:
            ...
            if not kie_config:
                kie_config = osp.join(config_dir, 'kie/',
    ...
    def det_recog_kie_inference(self, det_model, recog_model, kie_model=None):
        ...
        for filename, arr, bboxes, out_file in zip(self.args.filenames,
            ...
            for bbox in bboxes:
                ...
                box_img = crop_img(arr, box, long_edge_pad_ratio=0.1, short_edge_pad_ratio=0.1)
